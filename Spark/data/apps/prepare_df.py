...
spark = SparkSession.builder\
         ...
         .appName("Step2_03-Hashtag-Processing-Console")\
...
df = spark\
   ...
   .option("kafka.group.id", "step2_3-add-hashtags-console")\
   .load()
...
tweetsDF.select(col("id"),col("hashtags"), col("sendTime"), col("senderName"), col("persianYear"),col("persianMonth"), col("persianDay"))\
      .writeStream\
      .format("console")\
      .outputMode("append")\
      .start()\
